...
* You must use the `class` notation for defining your class and ex`tends
...
[Abdelmajid Essaid 😉](https://github.com/abdelemjidessaid/alx-higher_level_programming/tree/main/0x13-javascript_objects_scopes_closures)
